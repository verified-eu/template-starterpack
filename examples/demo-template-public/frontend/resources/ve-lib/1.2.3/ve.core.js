...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _remote = __webpack_require__(246);
	
	var _remote2 = _interopRequireDefault(_remote);
	
	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }
	
	var VeLib = { actions: _actions2.default, configs: _configs2.default, helpers: _helpers2.default, state: _state2.default, remote: _remote2.default };
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _parsers = __webpack_require__(277);
	
	var _parsers2 = _interopRequireDefault(_parsers);
	
	var _identity = __webpack_require__(278);
	...
	var Actions = function () {
		...
		_createClass(Actions, [{
			...
			value: function init(_ref) {
				var descriptor_id = _ref.descriptor_id,
				    initialState = _ref.initialState;
	
	
				if (initialState) _state2.default.merge({}, initialState);
	
				var qParams = _parsers2.default.getQueryParams({ descriptor_id: descriptor_id });
	
				_state2.default.merge({ params: qParams });
	
				return _identity2.default.set(qParams).then(function () {
					return _helpers2.default.getRemoteEntitiesPromise().then(function (remoteEntities) {
						_state2.default.merge({ remoteEntities: remoteEntities });
						return _state2.default.get();
			...
			key: 'getMyRoles',
			value: function getMyRoles() {
	
				var roles = [defaultOwnerRole];
				var tokenRoles = null;
	
				if (_state2.default.get().remoteEntities.user && _state2.default.get().remoteEntities.user.roles) {
					tokenRoles = _state2.default.get().remoteEntities.user.roles;
					tokenRoles = tokenRoles.filter(function (role) {
						return role.label === 'roles' || role.label === 'descriptors';
					});
				}
			...
			key: 'runFlowTask',
			value: function runFlowTask(_ref2) {
				var taskName = _ref2.taskName,
				    body = _ref2.body;
	
				if (taskName) taskName = '/' + taskName;
	
				var envelope_id = _state2.default.get().remoteEntities.envelope.id;
	
				return _remote2.default.callForData({
					method: "POST",
					url: _configs2.default.get().envelopesAppendix + '/' + envelope_id + _configs2.default.get().jobsAppendix + taskName,
					body: body
				});
			}
		}]);
	...
	var Helpers = function () {
		...
		_createClass(Helpers, [{
			...
			value: function getRemoteEntitiesPromise() {
				var _state$get$params = _state2.default.get().params,
				    document_uid = _state$get$params.document_uid,
				    descriptor_id = _state$get$params.descriptor_id;
	
				return _remote2.default.callForData({ method: "GET", url: "" + _configs2.default.get().userinfoUrl }).then(function (user) {
					if (document_uid) {
						var envelopeUid = document_uid.match(/^(\/envelopes\/[^/]+)\//)[1];
	
						return _remote2.default.callForData({ method: "GET", url: envelopeUid }).then(function (envelope) {
							var document = envelope.documents.find(function (doc) {
								return doc.uid === document_uid;
							});
							if (!document) throw { code: 404, message: "Document not found" };
	
							var descriptor = envelope.descriptor,
							    template = document.template;
	
							return _remote2.default.callForData({ method: "GET", url: "" + template.uid + _configs2.default.get().userDataAppendix }).then(function (userData) {
								template.userData = userData;
								return { envelope: envelope, descriptor: descriptor, document: document, template: template, user: user };
							}).catch(function (err) {
						...
						return _remote2.default.callForData({ method: "GET", url: "/envelope-descriptors/" + descriptor_id }).then(function (descriptor) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var qs = __webpack_require__(274);
		...
		_createClass(Remote, [{
			...
			value: function _call(_ref) {
				var method = _ref.method,
				    ...
				    overwriteToken = _ref.overwriteToken,
				    disableToken = _ref.disableToken,
				    _ref$credentials = _ref.credentials,
				    credentials = _ref$credentials === undefined ? 'same-origin' : _ref$credentials;
	
				if (_state2.default.get().internal.companyUid) headers["x-namespace"] = _state2.default.get().internal.companyUid;
				...
				if ((token = _state2.default.get().internal.accessToken) && !disableToken) {
				...
				return (0, _axios2.default)({
					url: "" + _configs2.default.apiBase + url,
					method: method || "GET",
					headers: headers,
					data: body,
	...
	var expose = {
		callAndReturnLocation: function callAndReturnLocation(_ref2) {
			var method = _ref2.method,
			    url = _ref2.url,
			    body = _ref2.body,
			    params = _ref2.params,
			    overwriteToken = _ref2.overwriteToken;
		...
		callForData: function callForData(opts) {
			console.info("calling for data , with options", opts);
			return remote._call(opts).then(function (response) {
				return response.data;
			});
		},
		callRaw: function callRaw(opts) {
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var objectAssign = __webpack_require__(276);
...
/***/ (function(module, exports, __webpack_require__) {
	...
	var Parsers = function () {
		...
		_createClass(Parsers, [{
			key: "getQueryParams",
			value: function getQueryParams(additionalParamObjectVales) {
	...
	var Identity = function () {
		...
		_createClass(Identity, [{
			...
			value: function set(_ref) {
				...
				var data = _.merge({}, { accessToken: access_token });
				...
				return new Promise(function (resolve, reject) {
					...
					_state2.default.merge({ internal: data });
