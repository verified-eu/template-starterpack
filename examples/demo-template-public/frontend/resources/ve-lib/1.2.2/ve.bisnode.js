	...
	var Actions = function () {
		...
		_createClass(Actions, [{
			...
			value: function getCompanyInfo(regNumber) {
				return callForData({
					method: "GET",
					url: "" + _configs.configs.get().bisnodeUrl + _configs.configs.get().companySuffix + "?regNumber=" + regNumber
				});
			}
		}, {
			key: "getPersonInfo",
			value: function getPersonInfo(ssn) {
				return callForData({
					method: "GET",
					url: "" + _configs.configs.get().bisnodeUrl + _configs.configs.get().personSuffix + "?personNumber=" + ssn
				});
			}
		}, {
			key: "getNorwayCompany",
			value: function getNorwayCompany(regNumber) {
				return callForData({
					method: "GET",
					url: "" + _configs.configs.get().bisnodeUrl + _configs.configs.get().norwayCompanySuffix + "?regNumber=" + regNumber
				});
			}
		}]);
